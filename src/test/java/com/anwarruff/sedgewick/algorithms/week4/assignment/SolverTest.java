...
public class SolverTest {
    ...
    public void testComparator() {
        ...
        Collections.sort(boards, Solver.getBoardComparator());
        assertTrue(boards.get(0).equals(b1));
        assertTrue(boards.get(1).equals(b2));
        assertTrue(boards.get(2).equals(b3));
    }
